...
```
- Solution File: [0-create_a_file.pp](./0-create_a_file.pp)
...
Werkzeug 2.1.1
```
- Solution File: [1-install_a_package.pp](./1-install_a_package.pp)
...
root@d391259bf577:/#
```
- Solution File: [2-execute_a_command.pp](./2-execute_a_command.pp)

---
- GitHub repository: [alx-system_engineering-devops](../README.md)
- Directory: [0x0A-configuration_management](./README.md)
