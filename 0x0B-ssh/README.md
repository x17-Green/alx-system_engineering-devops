...
green@greenhouse$ ./1-create_ssh_key_pair
...
green@greenhouse$ 
```
- Solution File: [1-create_ssh_key_pair](./1-create_ssh_key_pair)
---
...
Example:
```
green@greenhouse$ ssh -v ubuntu@98.98.98.98
...
- Solution File: [2-ssh_config](./2-ssh_config)
...
Example:
```
green@greenhouse:$ sudo puppet apply 100-puppet_ssh_config.pp
[sudo] password for green: 
Notice: Compiled catalog for greenhouse in environment production in 0.02 seconds
Notice: /Stage[main]/Main/File[/etc/ssh/ssh_config]/content: content changed '{sha256}db853f12a26c45156465c188faa1c81c8aeac4cd9829e65c3ab5502e2210e855' to '{sha256}3c8c6855f98193847562658e603fba41fc151fb753c71c3e77a0edf3aac9981b'
Notice: /Stage[main]/Main/File[/etc/ssh/ssh_config]/owner: owner changed 'root' to 'green'
Notice: /Stage[main]/Main/File[/etc/ssh/ssh_config]/group: group changed 'root' to 'green'
Notice: /Stage[main]/Main/File[/etc/ssh/ssh_config]/mode: mode changed '0644' to '0600'
Notice: Applied catalog in 0.27 seconds
 
green@greenhouse:
```
- Solution File: [100-puppet_ssh_config.pp](./100-puppet_ssh_config.pp)
